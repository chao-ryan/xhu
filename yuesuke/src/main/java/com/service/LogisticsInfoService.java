...
public interface LogisticsInfoService {
     ...
     *
     */
    public com.domain.LogisticsInfo findLogisticsInfoByOrderDetailId(Long OrderDetailId);
     ...
     *
     */
    public List<com.domain.LogisticsInfo> findLogisticsInfoAll();
     ...
     *
     */
    public Integer saveLogisticsInfo(com.domain.LogisticsInfo logisticsInfo);
     ...
     *
     */
    public Integer deleteLogisticsInfoById(com.domain.LogisticsInfo logisticsInfo);
     ...
     *
     */
    public Integer updateLogisticsInfoByOrderDetailId(com.domain.LogisticsInfo logisticsInfo);
}
