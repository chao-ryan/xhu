...
public class ClassRelationDao extends BaseDao<ClassRelation> implements Dao<ClassRelation> {
     ...
     * @Description: 保存/添加
     * @author dengchao
     * @param classRelation 需要保存/添加的classRelation对象
     * @return 返回受影响行数
     * @date 2018/3/23
     */
    @Override
    public Integer save(ClassRelation classRelation) {
        return super.sqlSessionTemplate.insert(getMybatisNameSpace()+"save",classRelation);
    }
     ...
     * @Description: 修改/更新
     * @author dengchao
     * @param classRelation 需要修改/更新的E对象
     * @return 返回受影响行数
     * @date 2018/3/23
     */
    @Override
    public Integer update(ClassRelation classRelation) {
        return super.sqlSessionTemplate.update(getMybatisNameSpace()+"update",classRelation);
    }
