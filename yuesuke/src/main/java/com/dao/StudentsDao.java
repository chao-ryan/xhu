 ...
 * @Description 学生信息 dao
 * @date 2018/3/23
 */
public class StudentsDao extends BaseDao<Students> implements Dao<Students> {
    /**
     * @Title: deleteById
     ...
     * @Description: 保存/添加
     * @author dengchao
     * @param students 需要保存/添加的classRelation对象
     * @return 返回受影响行数
     * @date 2018/3/23
     */
    @Override
    public Integer save(Students students) {
        return super.sqlSessionTemplate.insert(getMybatisNameSpace()+"save",students);
    }
    /**
     * @Title: update
     * @Description: 修改/更新
     * @author dengchao
     * @param students 需要修改/更新的E对象
     * @return 返回受影响行数
     * @date 2018/3/23
     */
    @Override
    public Integer update(Students students) {
        return super.sqlSessionTemplate.update(getMybatisNameSpace()+"update",students);
    }
    /**
     * @Title: findById
     * @Description: 根据id查找
