...
import com.service.PayFlowService;
...
public class PayFlowDaoImpl extends BaseDaoImpl<PayFlow> implements PayFlowDao {
    ...
    public PayFlow findPayFlowById(Long id){
        Map map=new HashMap();
        map.put("id",id);
//        List<PayFlow> payFlowsList=this.sqlSessionTemplate.selectList(getMybaitsNameSpace()+"getAll");
        return this.sqlSessionTemplate.selectOne(getMybaitsNameSpace()+"payFlowById",id);
    }
    ...
    public PayFlow findPayFlowByFlowNum(String flowNum) throws SQLException {
        Map map=new HashMap();
        map.put("flow_num",flowNum);
        return this.sqlSessionTemplate.selectOne(getMybaitsNameSpace()+"payFlowByFlowNum",map);
//        return null;
    }
    ...
    public int savePayFlow(PayFlow payFlow){
        Map map=new HashMap();
        map.put("pay_flow",payFlow);
        return this.sqlSessionTemplate.insert(getMybaitsNameSpace()+"add",map);
    }
...
//     */
//    @Override
//    public int savePayFlow(PayFlow payFlow) throws SQLException {
//        Map map=new HashMap<>();
//        map.put("pay_flow",payFlow);
//        return this.sqlSessionTemplate.insert(getMybaitsNameSpace() + "add", map);
//    }
