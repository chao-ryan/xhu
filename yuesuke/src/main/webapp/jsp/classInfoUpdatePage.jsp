...
<div class="beg-login-box">
    ...
    <div class="column">
        ...
        <div class="content-box" id="content_box">
            <!-- 修改班级信息页面弹出层 -->
            <div id="classinfo-update-pop-up-box" style="display: block">
                <div class="update-pop-up-head-box">
                    ...
                    <div class="update-pop-up-head-close-box">
                        <button type="button" class="update-pop-up-close-button" value="关闭" onclick="closeupdate()" id="close_update_class">
                            <a href="${pageContext.request.contextPath}/action/classInfo!classInfoShow.do?toUpClassName=${relationListUp.getClassInfoId().getName()}">
                                <span>X</span>
                            </a>
                        </button>
                    </div>
                    ...
                    <div class="pop-up-body-form-box">
                        <form>
                            ...
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-title_number" value="${relationListUp.getClassInfoId().getNumber()}" readonly="readonly" name="classNumUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-name" for="L-title_name">班级名称</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-title_name" value="${relationListUp.getClassInfoId().getName()}" required="required" name="classNameUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-college" for="L-title_college">所属学院</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-title_college" value="${relationListUp.getCollegeId().getName()}" name="classCollegeUp" readonly="readonly" required="required"  autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-stunumber" for="L-title_stunumber">学生人数</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-title_stunumber" value="${relationListUp.getClassInfoId().getStudentsNumber()}" name="classStuNameUp" autocomplete="off"/>
                            </div><br/>
                            <label class="class-teacher" for="L-title_teacher">辅导员</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-title_teacher" value="${relationListUp.getClassInfoId().getTeachersId().getName()}" required="required" name="classTeacherUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-major" for="L-title_major">年级专业</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-title_major" value="${relationListUp.getClassInfoId().getMajor()}" required="required" name="classMajorUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-year" for="L-title_year">年级</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-title_year" value="${relationListUp.getGrade()}" required="required" name="classYearUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/><br/>
