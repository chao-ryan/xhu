...
<div class="beg-login-box">
    ...
    <div class="column">
        ...
        <div class="content-box" id="content_box">
            <!-- 添加学院信息页面弹出层 -->
            <div class="college-add-pop-up-box" id="college-add-pop-up-box" style="display: block">
                <div class="update-pop-up-head-box">
                    ...
                    <div class="update-pop-up-head-close-box">
                        <button type="button" class="update-pop-up-close-button" value="关闭" onclick="closeaddcollege()" id="close_add_college">
                            <a href="${pageContext.request.contextPath}/action/college!collegeShow.do">
                                <span>X</span>
                            </a>
                        </button>
                    </div>
                ...
                <div class="update-pop-up-body-box">
                    <div class="pop-up-body-form-box">
                        <form>
                            <label class="class-name" for="L-college_name_add">学院名称</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-college_name_add" value="" required="required" name="collegeNameAdd" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-stunumber" for="L-college_stunumber_add">学生人数</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-college_stunumber_add" name="collegeStuNumAdd" autocomplete="off"/>
                            </div><br/>
                            <label class="class-teacher" for="L-college_teacher_add">师资队伍</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-college_teacher_add" name="collegeTeaAdd" autocomplete="off"/>
                            </div><br/>
