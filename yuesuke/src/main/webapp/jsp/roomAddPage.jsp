...
<div class="beg-login-box">
    ...
    <div class="column">
        ...
        <div class="content-box" id="content_box">
            <!-- 添加宿舍信息页面弹出层 -->
            <div class="room-add-pop-up-box" id="room-add-pop-up-box" style="display: block">
                <div class="update-pop-up-head-box">
                    ...
                    <div class="update-pop-up-head-close-box">
                        <button type="button" class="update-pop-up-close-button" value="关闭" onclick="closeaddroom()" id="close_add_room">
                            <a href="${pageContext.request.contextPath}/action/room!roomShow.do">
                                <span>X</span>
                            </a>
                        </button>
                    </div>
                ...
                <div class="update-pop-up-body-box">
                    <div class="pop-up-body-form-box">
                        <form>
                            ...
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_loudong_add" value="" required="required" name="roomLouDongAdd" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="room-floor-number" for="L-room_floor_number_add">楼层号</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_floor_number_add" value="" required="required" name="roomFloorAdd" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="room-room-number" for="L-room_room_number_add">房间号</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_room_number_add" name="roomNumberAdd" autocomplete="off"/>
                            </div><br/>
                            <label class="room-auntie-name" for="L-room_auntie_name_add">宿管阿姨</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_auntie_name_add" name="roomAuntieAdd" autocomplete="off"/>
                            </div><br/>
                            <label class="room-students-number" for="L-room_students_number_add">学生人数</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_students_number_add" name="roomStuNumAdd" autocomplete="off"/>
                            </div><br/>
                            <label class="room-empty-number" for="L-room_empty_number_add">空房间数</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_empty_number_add" name="roomEmptyAdd" autocomplete="off"/>
                            </div><br/>
