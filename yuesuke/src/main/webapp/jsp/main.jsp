...
var sysBBS="<span style='font-size:14px; line-height:30px;'>欢迎光临YS聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
//此处需要加?nocache="+new Date().getTime()，否则将出现在线人员列表不更新的情况
function showOnline(){
	var loader=new net.AjaxRequest("/jsp/online.jsp?nocache="+new Date().getTime(),deal_online,onerror,"GET");
}
function showContent(){
	var loader1=new net.AjaxRequest("/servlet/Messages.servlet?action=getMessages&nocache="+new Date().getTime(),deal_content,onerror,"GET");
}
function onerror(){
...
<!--
	function send(){	//验证聊天信息并发送
        ...
        var loader=new net.AjaxRequest("/servlet/Messages.servlet?action=sendMessage",deal_send,onerror,"POST",param);
...
<body >
<table width="778" height="150" border="0" align="center" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath}/img/top.jpg">
    <tr>
        <td>&nbsp;</td>
    </tr>
</table>
<table width="778" height="276" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="165" valign="top" bgcolor="lightblue" id="online" style="padding:5px">
            在线人员列表
        </td>
        <td width="613"  height="200px" valign="top" background="${pageContext.request.contextPath}/img/main_bj.jpg" bgcolor="aliceblue" style="padding:5px; ">
            <div style="height:290px; overflow:hidden" id="content">聊天内容</div>
        </td>

    </tr>
</table>
<table width="778" height="95" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#D6D3CE" background-col="images/bottom.jpg">
    ...
    <form action="" name="form1" method="post" >
        ...
        <tr>
            ...
            <td width="549" align="left">
                ...
                <input name="content1" type="text" size="70" onKeyDown="if(event.keyCode==13 && event.ctrlKey){send();}" id="main_send_input" autofocus="autofocus">
                <button name="Submit2" type="button" class="btn_grey" value="发送" onClick="send()" id="main_send_button">
                    发 送
                </button>
            </td>
            <td align="right">
                <button name="button_exit" type="button" class="btn_grey" value="退出聊天室" onClick="Exit()" id="main_exit_button">
                    退出聊天室
                </button>
            </td>
            <td align="center">&nbsp;</td>
        ...
        <tr>
            <td height="30" align="left">&nbsp;</td>
            <td colspan="2" align="center" class="word_dark">&nbsp;<span id="main_word_dark_span">哈哈哈哈哈哈哈哈哈哈哈哈哈</span></td>
            <td align="center">&nbsp;</td>
        </tr>
    </form>
</table>
