...
<div class="beg-login-box">
    ...
    <div class="column">
        ...
        <div class="content-box" id="content_box">
            <!-- 修改学生信息页面弹出层 -->
            <div id="student-update-pop-up-box" style="display: block">
                <div class="update-pop-up-head-box">
                    ...
                    <div class="update-pop-up-head-close-box">
                        <button type="button" class="update-pop-up-close-button" value="关闭" onclick="closeupdatecollege()" id="close_update_student">
                            <a href="${pageContext.request.contextPath}/action/student!stuShow.do?toUpStuName=${relationListUp.getStudentsId().getName()}">
                                <span>X</span>
                            </a>
                        </button>
                    </div>
                    ...
                    <div class="stu-pop-up-body-form-box">
                        <form>
                            ...
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_account" readonly="readonly" value="${relationListUp.getStudentsId().getAccountId().getAccountNumber()}" name="stuAccountUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><span class="warning-span">**</span><br/>
                            <label class="stu-name" for="L-stu_name">姓名</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_name" value="${relationListUp.getStudentsId().getName()}" name="stuNameUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><span class="warning-span">**</span><br/>
                            <label class="stu-sex" for="stu_sex_select_update">性别</label>
                            <div class="stu-pop-up-body-input-box">
                                <div class="stu-sex-input-block">
                                    <select name="stuSexUp" lay-verify="required" id="stu_sex_select_update">
                                        <option></option>
                                        <optgroup label="性别">
                            ...
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_birth" value="${relationListUp.getStudentsId().getBirthday()}" name="stuBirthDayUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-rigin" for="L-stu_origin">籍贯</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_origin" value="${relationListUp.getStudentsId().getOrigin()}" name="stuOriginUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><span class="warning-span">**</span><br/>
                            <label class="stu-enthnic" for="stu_enthnic_select_update">民族</label>
                            <div class="stu-pop-up-body-input-box">
                                <div class="stu-enthnic-input-block">
                                    <select name="stuEnthnicUp" lay-verify="required" id="stu_enthnic_select_update">
                                        <option></option>
                                        <optgroup label="民族">
                            ...
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_id_number" value="${relationListUp.getStudentsId().getIdNumber()}" readonly="readonly" name="stuIdNumUp" autocomplete="off" placeholder="必填"/>
                            </div><span class="warning-span">**</span><br/>
                            <label class="stu-university" for="L-stu_university">学校</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_university" value="${relationListUp.getStudentsId().getUniversity()}" readonly="readonly" name="stuUniversityUp" autocomplete="off" placeholder="必填"/>
                            </div><span class="warning-span">**</span><br/>
                            <label class="stu-phone" for="L-stu_phone">手机号</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_phone" value="${relationListUp.getStudentsId().getPhone()}" name="stuPhoneUp" autocomplete="off" placeholder="必填"/>
                            </div><span class="warning-span">**</span><br/>
                            <label class="stu-family" for="L-stu_family">家庭人口</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_family" value="${relationListUp.getStudentsId().getFamilyPopulation()}" name="stuFamilyUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-father_name" for="L-stu_father_name">父亲</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_father_name" value="${relationListUp.getStudentsId().getFatherName()}" name="stuFatherNameUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-father_phone" for="L-stu_father_phone">父亲联系方式</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_father_phone" value="${relationListUp.getStudentsId().getFatherPhone()}" name="stuFatherPhoneUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-father_address" for="L-stu_father_address">现居地</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_father_address" value="${relationListUp.getStudentsId().getFatherAddress()}" name="stuFatherAddressUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-mother_name" for="L-stu_mother_name">母亲</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_mother_name" value="${relationListUp.getStudentsId().getMotherName()}" name="stuMotherNameUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-mother_phone" for="L-stu_mother_phone">母亲联系方式</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_mother_phone" value="${relationListUp.getStudentsId().getMotherPhone()}" name="stuMotherPhoneUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-mother_address" for="L-stu_mother_adress">现居地</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_mother_adress" value="${relationListUp.getStudentsId().getMotherAddress()}" name="stuMotherAddressUp" autocomplete="off"/>
                            </div><br/>
                            <label class="stu-room" for="L-stu_room">宿舍信息</label>
                            <div class="stu-pop-up-body-input-box">
                                <input type="text" id="L-stu_room" value="${relationListUp.getStudentsId().getRoomId().getArea()}-${relationListUp.getStudentsId().getRoomId().getLoudong()}-${relationListUp.getStudentsId().getRoomId().getFloorNumber()}-${relationListUp.getStudentsId().getRoomId().getRoomNumber()}" name="stuRoomIdUp" autocomplete="off" placeholder="请输入各宿舍编号"/>
                            </div><br/>
