...
<div class="beg-login-box">
    ...
    <div class="column">
        ...
        <div class="content-box" id="content_box">
            <!-- 修改宿舍信息页面弹出层 -->
            <div id="room-update-pop-up-box" style="display: block">
                <div class="update-pop-up-head-box">
                    ...
                    <div class="update-pop-up-head-close-box">
                        <button type="button" class="update-pop-up-close-button" value="关闭" onclick="closeupdateroom()" id="close_update_room">
                            <a href="${pageContext.request.contextPath}/action/room!roomShow.do?toUpRoomArea=${roomUp.getArea()}">
                                <span>X</span>
                            </a>
                        </button>
                    </div>
                ...
                <div class="update-pop-up-body-box">
                    <div class="pop-up-body-form-box">
                        <form>
                            ...
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_loudong_update" value="${roomUp.getLoudong()}" required="required" name="roomLouDongUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            ...
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_room_number_update" value="${roomUp.getRoomNumber()}" name="roomNumberUp" autocomplete="off"/>
                            </div><br/>
                            ...
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_students_number_update" value="${roomUp.getStudentsNumber()}" name="roomStuNumUp" autocomplete="off"/>
                            </div><br/>
                            <label class="room-empty-number" for="L-room_empty_number_update">空房间数</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-room_empty_number_update" value="${roomUp.getEmptyRoom()}" name="roomEmptyUp" autocomplete="off"/>
                            </div><br/>
