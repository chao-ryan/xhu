...
<div class="beg-login-box">
    ...
    <div class="column">
        ...
        <div class="content-box" id="content_box">
            <!-- 修改学院信息页面弹出层 -->
            <div id="college-update-pop-up-box" style="display: block">
                <div class="update-pop-up-head-box">
                    ...
                    <div class="update-pop-up-head-close-box">
                        <button type="button" class="update-pop-up-close-button" value="关闭" onclick="closeupdatecollege()" id="close_update_college">
                            <a href="${pageContext.request.contextPath}/action/college!collegeShow.do?toUpCollegeName=${relationListUp.getClassInfoId().getName()}">
                                <span>X</span>
                            </a>
                        </button>
                    </div>
                ...
                <div class="update-pop-up-body-box">
                    <div class="pop-up-body-form-box">
                        <form>
                            <label class="class-number" for="L-college_number">编 号</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-college_number" value="${collegeListUp.getId()}" readonly="readonly" name="collegeNumUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-name" for="L-college_name">学院名称</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-college_name" value="${collegeListUp.getName()}" name="collegeNameUp" autocomplete="off" placeholder="此项为必填项"/>
                            </div><br/>
                            <label class="class-stunumber" for="L-college_stunumber">学生人数</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-college_stunumber" value="${collegeListUp.getStudentsNumber()}" name="collegeStuNumUp" autocomplete="off"/>
                            </div><br/>
                            <label class="class-teacher" for="L-college_teacher">师资队伍</label>
                            <div class="pop-up-body-input-box">
                                <input type="text" id="L-college_teacher" value="${collegeListUp.getTeachersNumber()}" name="collegeTeacherNumUp" autocomplete="off"/>
                            </div><br/>
